...
prompt = ChatPromptTemplate.from_template("""You are Iraqi Arabic speaker. Your task is to correct the punctuation in the Iraqi Arabic text below. Return only the corrected text without any other explanation.
